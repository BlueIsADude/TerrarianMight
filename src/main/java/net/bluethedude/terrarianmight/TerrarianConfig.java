...
public class TerrarianConfig extends MidnightConfig {
    ...
    @Entry(category = HEALTHY_DOSE, min = 0) public static int fruitCooldown = 500;
    @Entry(category = HEALTHY_DOSE, min = 0) public static int fruitDuration = 600;
    ...
    @Entry(category = HEALTHY_DOSE, min = 0) public static int lanternDuration = 300;
